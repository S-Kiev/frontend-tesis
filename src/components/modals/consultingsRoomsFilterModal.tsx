...
interface ConsultingsRoomsFilterModalProps {
  show: boolean;
...
export const ConsultingsRoomsFilterModal: FC<ConsultingsRoomsFilterModalProps> = ({
  show,
  showModal,
  setFilter,
  filter,
  ...
  const options = [
    ...
    { value: ConsultingRoomStatusEnum.available, label: 'Disponible' },
    { value: ConsultingRoomStatusEnum.occupied, label: 'Ocupado' },
    { value: ConsultingRoomStatusEnum.outOfUse, label: 'Fuera de servicio' },
  ];
    ...
    <>
      <Modal onHide={() => showModal(false)} show={show} centered>
        <Modal.Header closeButton>
          <Modal.Title>
            <Funnel color="rgba(8, 135, 93, 1)" size={30} className="me-2" /> Filtros Consultorios
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
